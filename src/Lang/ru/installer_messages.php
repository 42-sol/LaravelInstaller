...
return [
    ...
    'database' => [
        ...
        'label' => 'Использовать сидеры (заполнить некоторые таблицы с "общими" данными (типы докуметов, активов и т.п.))',
        'migrate' => 'Выполнить миграции',
        'inProgress' => 'Миграции выполняются. После окончания процесса вы будите перенаправлены далее',
